...
<div style="display: flex; gap: 15px; margin: 25px 0; flex-wrap: wrap; justify-content: center;">
  <img src="/images/news/mcri_retreat_2025/WhatsApp Image 2025-10-09 at 5.05.40 PM.jpeg" alt="MCRI Retreat 2025 - Poster Presentation" style="width: 100%; max-width: 350px; height: 350px; object-fit: cover; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
  <img src="/images/news/mcri_retreat_2025/WhatsApp Image 2025-10-09 at 5.05.40 PM (1).jpeg" alt="MCRI Retreat 2025 - Award Recognition" style="width: 100%; max-width: 350px; height: 350px; object-fit: cover; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
</div>
